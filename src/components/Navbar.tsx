...
import { IdCard, LogOut, QrCode, ShieldCheck, User, Search, PlusCircle, LayoutDashboard } from 'lucide-react';
import { UNIVERSITY_NAME } from '../constants';

interface NavbarProps {
  setView: (view: 'dashboard' | 'scanner') => void;
  currentView: 'dashboard' | 'scanner';
}
